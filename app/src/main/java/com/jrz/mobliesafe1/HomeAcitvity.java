...
import com.jrz.mobliesafe1.chapter01.adapter.HomeAdapter;
import com.jrz.mobliesafe1.chapter02.LostFindActivity;
import com.jrz.mobliesafe1.chapter02.dIalog.InterPasswordDialog;
import com.jrz.mobliesafe1.chapter02.dIalog.SetupPasswordDialog;
import com.jrz.mobliesafe1.chapter02.receiver.MyDeviceAdminReciever;
import com.jrz.mobliesafe1.chapter02.utils.MD5Utils;
import com.jrz.mobliesafe1.chapter03.SecurityPhoneActivity;
import com.jrz.mobliesafe1.chapter04.AppManagerActivity;
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        startActivity2(AppManagerActivity.class);
                }
            }

            private void startActivity2(Class<AppManagerActivity> appManagerActivityClass) {
                Intent intent = new Intent(HomeAcitvity.this,appManagerActivityClass);
                HomeAcitvity.this.startActivity(intent);
            }

            private void startActivity(Class<SecurityPhoneActivity> securityPhoneActivityClass) {
                Intent intent = new Intent(HomeAcitvity.this,securityPhoneActivityClass);
                HomeAcitvity.this.startActivity(intent);
            }
        });
        //1.获取设备管理员
