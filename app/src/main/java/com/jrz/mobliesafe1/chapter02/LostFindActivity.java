...
public class LostFindActivity extends Activity implements View.OnClickListener {
    ...
    private void initView(){
        ...
        mSafePhoneTV = findViewById(R.id.tv_safephone);
        mSafePhoneTV.setText(msharedPreferences.getString("safephone",""));
        mToggleButton = findViewById(R.id.togglebtn_lostfind);
        mInterSetupRL = findViewById(R.id.rl_inter_setup_wizard);
        mInterSetupRL.setOnClickListener(this);
        mProtectStatusTV = findViewById(R.id.tv_lostfind_protectstauts);
        //查询手机防盗是否开启。默认为开启
